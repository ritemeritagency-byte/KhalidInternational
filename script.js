...
const TRANSLATIONS = {
  EN: {
    ...
    new_hiring_kicker: 'NEW HIRING',
    new_hiring_title: 'Fresh Openings Ready for Immediate Applications',
    new_hiring_desc: 'Newly added roles with photo-based previews so applicants can quickly spot the latest hiring updates.',
    country_gcc_hiring: 'GCC Opportunities',
    salary_by_employer: 'Salary depends on employer offer',
    tag_new_opening: 'New Opening',
    tag_hot_hiring: 'Hot Hiring',
    role_hairstylist: 'Hairstylist',
    role_manicurist: 'Manicurist',
    meta_new_this_week: 'New this week',
    meta_limited_slots: 'Limited interview slots',
    meta_priority_screening: 'Priority screening',
    ...
    faq_title: 'Quick Answers for Applicants',
    faq_q1: 'Is there a placement fee?',
    faq_a1: 'No. Khalid International follows a no placement fee policy for applicants.',
    faq_q2: 'What countries do you deploy to?',
    faq_a2: 'We currently process opportunities for UAE Dubai, Qatar, and Kuwait.',
    faq_q3: 'Do I need a passport before applying?',
    faq_a3: 'You can apply even without a passport yet. Our team will guide you on next steps.',
    faq_q4: 'How long does processing take?',
    faq_a4: 'Processing time depends on position, documents, and employer requirements. We provide updates at every step.',
    faq_q5: 'How will I receive updates?',
    faq_a5: 'Your assigned specialist will contact you via WhatsApp or phone for interview and document updates.',
    faq_q6: 'Where is your office located?',
    faq_a6: 'Our office is at 2269 Nakar St., San Andres Bukid, Manila, Philippines.',
    ...
    opt_hairstylist: 'Hairstylist',
    opt_manicurist: 'Manicurist',
  ...
  TL: {
    ...
    country_all_hiring: 'Qatar / UAE / Kuwait',
    new_hiring_kicker: 'BAGONG HIRING',
    new_hiring_title: 'Mga Bagong Opening na Puwedeng Applyan Kaagad',
    new_hiring_desc: 'Mga bagong dagdag na role na may photo preview para madaling makita ang pinakabagong hiring updates.',
    country_gcc_hiring: 'Mga Opportunity sa GCC',
    salary_by_employer: 'Ang sahod ay depende sa employer offer',
    tag_new_opening: 'Bagong Opening',
    tag_hot_hiring: 'Mainit na Hiring',
    role_hairstylist: 'Hairstylist',
    role_manicurist: 'Manicurist',
    meta_new_this_week: 'Bago ngayong linggo',
    meta_limited_slots: 'Limitadong interview slots',
    meta_priority_screening: 'Priority screening',
    ...
    faq_kicker: 'MADALAS ITANONG',
    faq_title: 'Mabilis na Sagot para sa mga Aplikante',
    faq_q1: 'May placement fee ba?',
    faq_a1: 'Wala. No placement fee ang polisiya ng Khalid International para sa mga aplikante.',
    faq_q2: 'Anong mga bansa ang deployment ninyo?',
    faq_a2: 'Kasalukuyan kaming may opportunities para sa UAE Dubai, Qatar, at Kuwait.',
    faq_q3: 'Kailangan ba ng passport bago mag-apply?',
    faq_a3: 'Puwede kang mag-apply kahit wala ka pang passport. Gagabayan ka ng team sa susunod na hakbang.',
    faq_q4: 'Gaano katagal ang processing?',
    faq_a4: 'Depende ang processing sa position, dokumento, at requirements ng employer. May update ka sa bawat step.',
    faq_q5: 'Paano ako makakatanggap ng updates?',
    faq_a5: 'Ang assigned specialist mo ang mag-uupdate sa iyo sa WhatsApp o tawag para sa interview at documents.',
    faq_q6: 'Saan ang office ninyo?',
    faq_a6: 'Nasa 2269 Nakar St., San Andres Bukid, Manila, Philippines ang aming office.',
    support_kicker: 'SUPPORT TEAM',
  ...
  CEB: {
    ...
    country_all_hiring: 'Qatar / UAE / Kuwait',
    new_hiring_kicker: 'BAG-ONG HIRING',
    new_hiring_title: 'Bag-ong Openings nga Pwede Na Dayon Nimo Applyan',
    new_hiring_desc: 'Bag-ong nadugang nga mga role nga adunay photo preview aron dali makita ang pinakabag-ong hiring updates.',
    country_gcc_hiring: 'Mga Opportunity sa GCC',
    salary_by_employer: 'Ang sweldo magdepende sa offer sa employer',
    tag_new_opening: 'Bag-ong Opening',
    tag_hot_hiring: 'Init nga Hiring',
    role_hairstylist: 'Hairstylist',
    role_manicurist: 'Manicurist',
    meta_new_this_week: 'Bago ni nga semana',
    meta_limited_slots: 'Limitado ang interview slots',
    meta_priority_screening: 'Priority screening',
    ...
    faq_kicker: 'KANUNAY NGA MGA PANGUTANA',
    faq_title: 'Paspas nga Tubag para sa mga Aplikante',
    faq_q1: 'Naay placement fee?',
    faq_a1: 'Wala. No placement fee ang polisiya sa Khalid International para sa mga aplikante.',
    faq_q2: 'Unsa nga mga nasod ang inyong deployment?',
    faq_a2: 'Sa karon, naa mi opportunities para sa UAE Dubai, Qatar, ug Kuwait.',
    faq_q3: 'Kinahanglan ba og passport sa dili pa mag-apply?',
    faq_a3: 'Pwede ka mag-apply bisan wala pa kay passport. Giyahan ka sa among team sa sunod nga mga lakang.',
    faq_q4: 'Pila ka dugay ang processing?',
    faq_a4: 'Magdepende ang processing sa position, dokumento, ug requirements sa employer. Naay updates sa matag step.',
    faq_q5: 'Unsaon nako pagdawat sa updates?',
    faq_a5: 'Ang imong assigned specialist mo-contact nimo pinaagi sa WhatsApp o tawag para sa interview ug dokumento.',
    faq_q6: 'Asa inyong opisina?',
    faq_a6: 'Ang among office naa sa 2269 Nakar St., San Andres Bukid, Manila, Philippines.',
    support_kicker: 'SUPPORT TEAM',
